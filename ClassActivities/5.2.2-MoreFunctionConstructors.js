...
function Animal(name, color, weight, personality){
  ...
  this.bio = `This is ${this.name}, The color of this animal is ${this.color}. It weighs ${this.weihgt} pounds. This animal has a ${this.personality} personality.`;
}
