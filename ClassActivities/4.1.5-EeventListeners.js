...
document.querySelector("#dog-picture").addEventListener("click", () => alert("the image was clicked"));
...
document.querySelector("#class-schedule-list > ol").addEventListener("mouseover", (event) => (event.target.style.backgroundColor = "blue"));
