...
const listOfCities = data.map(user => user.address.city);
console.log(listOfCities);
// create an array of latitude and longitude coordinate pairs
Const coordsLatLng = data.map(user =>
  [user.address.geo.lat, user.address.geo.lng]
  );
console.log(coordsLatLng);
// create an array of strings that combine the company's catchPhrase and bs
const companyJargon = data.map(user =>`${user.company.catchPhrase}${user.address.bs}`

);
console.logg(companyJargon);
